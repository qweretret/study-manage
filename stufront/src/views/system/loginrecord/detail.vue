				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="登录时间" prop="logintime">
							<el-input v-model="formParameter.logintime" autocomplete="off" disabled></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="24">
						<el-form-item label="登录结果" prop="loginresult">
							<el-input v-model="formParameter.loginresult == 1 ? '成功' : '失败'" autocomplete="off" disabled></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
