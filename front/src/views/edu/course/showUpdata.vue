<template>
	<popup ref="popup" :loading="popupLoading">
		<div slot="body">
		 	<el-table class="table" :data="records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
		...
		<div slot="footer">
			<el-button v-if="!disabled" type="primary" :loading="confirmLoading" @click="confirm()">确定导入</el-button>
				...
				api.imports(this.records,res=>{
                    ...
                    this.close()
                     ...
                     this.$emit("flush");
						...
						this.$utils.msg.warning("导入fail,亲联系管理员.");
				})
