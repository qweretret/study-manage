...
const api = {
	...
	tuisong: (params, successCallback, failCallback, exceptionCallback) => {
		ApiUtils.getLoadingAjax(constant.serverUrl + "/lky/tuisongzuoye/tuisong", params, successCallback, failCallback, exceptionCallback);
	},
	...
	save2: (params, successCallback, failCallback, exceptionCallback) => {
		ApiUtils.postLoadingAjax(constant.serverUrl + "/lky/tuisongzuoye/submittedToPush2", params, successCallback, failCallback, exceptionCallback);
	},
