...
import com.ossjk.qlh.interview.mapper.CompanyMapper;
...
public class CompanyServiceImpl extends ServiceImpl<CompanyMapper, Company> implements ICompanyService {
    ...
    @Override
    public List<Company> interaCname(String name) {

        return this.baseMapper.interaCname("%"+name+"%");
    }
}
